 ...
 */
@Stateless
public class TranferenciaExternaDAO {
    ...
    /**
     * Metodo que permite actualizar una Transferencia Externa en la base de
     * datos
     *
     ...
     *
     * @param codigoTransferenciaExterna Codigo que se utilizara para obtener la
     ...
     *
     * @param codigoTransferenciaExterna Codigo que se utiliza para poder
     * eliminar la Transferencia Externa
     */
    ...
    /**
     * Metodo que permite obtener las Transferencias Externas que estan
     * registradas en la base de datos
     *
     * @return Lista de Transferencias Externas que estan registradas en la base
     * de datos
     */
