...
public class TransaccionDAO {
     ...
     *
     * @param s El parametro s me permite registrar la Transaccion en la Base de
     * Datos
     */
     ...
     *
     * @param s El parametro s me permite actualiza la Transaccion con nuevos
     * valores
     */
     ...
     *
     * @param codigoTransaccion El parametro codigoTransaccion me permite buscar
     * una Transaccion con dicho codigo.
     ...
     *
     * @param codT El parametro codT me permite eliminar una Transaccion con el
     * codigo igual al parametro
     */
     ...
     *
     * @param cedula El parametro cedula me permite obtener todas las
     * transacciones realizadas por esa cedula perteneciente a un Cliente
     * @return Una lista de Transacciones realizadas de acuerdo al parametro
     * @throws Exception Excepcion para cuando no se encuentre ninguna
     * transaccion que se haya realizado.
     */
